...
$(document).ready(function () {
  ...
  var customIconsHTML = function (params) {
    ...
    var editIconHTML = "<a href='/admin/campaigns/"+ params.data.id +"/edit'><i class='users-edit-icon feather icon-edit-1 mr-50'></i></a>";
  ...
  var columnDefs = [{
    ...
    {
      headerName: 'Feed Category Name',
      field: 'feed_category_name',
      filter: true
    },
    {
      headerName: 'Clean URL',
      field: 'clean_url',
      filter: true
    },
    {
  ...
  if (document.getElementById("myGrid")) {
    ...
    agGrid
      .simpleHttpRequest({
        url: "/admin/campaigns/campaign_ajax_list"
      })
      .then(function (data) {
    ...
    $(".ag-grid-export-btn").on("click", function (params) {
      var params = {
          columnKeys: ['id', 'campaign_name', 'country_name', 'feed_category_name', 'clean_url'],
          fileName: 'webix_countries.csv'
      };
