...
$(document).ready(function () {
  ...
  var customIconsHTML = function (params) {
    ...
    var editIconHTML = "<a href='/admin/feed_sites/"+ params.data.id +"/edit'><i class='users-edit-icon feather icon-edit-1 mr-50'></i></a>";
    ...
    deleteIconHTML.addEventListener("click", function () {
      ...
      if (confirm("Are you sure you want to delete " + params.data.feed_site_name + "?")) {
        $.ajax({
          url: "/admin/feed_sites/" + params.data.id,
          type: "DELETE",
          cache: false,
          data:{
  ...
  var columnDefs = [{
    ...
    {
      headerName: 'Feed Site Name',
      field: 'feed_site_name',
      filter: true
    },
    {
      headerName: 'Feed Site Domain',
      field: 'feed_site_domain',
      filter: true
    },
    {
      headerName: 'Feed Site Status',
      field: 'feed_site_status',
      filter: true
    },
    {
      headerName: 'Actions',
  ...
  if (document.getElementById("myGrid")) {
    ...
    agGrid
      .simpleHttpRequest({
        url: "/admin/feed_sites/feed_site_ajax_list"
      })
      .then(function (data) {
    ...
    $(".ag-grid-export-btn").on("click", function (params) {
      var params = {
          columnKeys: ['id', 'feed_site_name', 'feed_site_domain' , 'feed_site_status'],
          fileName: 'webix_feed_sites.csv'
      };
