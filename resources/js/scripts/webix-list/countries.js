...
$(document).ready(function () {
  ...
  var customIconsHTML = function (params) {
    ...
    var editIconHTML = "<a href='/admin/countries/"+ params.data.id +"/edit'><i class='users-edit-icon feather icon-edit-1 mr-50'></i></a>";
  ...
  if (document.getElementById("myGrid")) {
    ...
    agGrid
      .simpleHttpRequest({
        url: "/admin/countries/country_ajax_list"
      })
      .then(function (data) {
    ...
    $(".ag-grid-export-btn").on("click", function (params) {
      var params = {
          columnKeys: ['id', 'country_name', 'country_code'],
