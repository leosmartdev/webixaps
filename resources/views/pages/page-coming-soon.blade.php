...
<section>
  <div class="row d-flex vh-50 align-items-center justify-content-center">

    <div class="col-xl-5 col-md-8 col-sm-10 col-12 px-md-0 px-1">

        <div class="card text-center w-100 mb-0 p-5 mb-1">
            <div class="card-content">
                <a href="/"><img src="{{ asset('images/logo/webix-logo-icon-sm.png') }}" class="img-responsive block width-150 mx-auto" width="150" alt="bg-img"></a>
            </div>
        </div>
