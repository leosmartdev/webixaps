      ...
      <div class="navbar-container content">
        <div class="navbar-collapse" id="navbar-mobile">
          <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
            @if (Auth::guard()->check())
              @if (Auth::user()->user_charity)
            <ul class="nav navbar-nav bookmark-icons">
              <li class="nav-item d-none d-lg-block"> <img src="/storage/charity_logos/{{ Auth::user()->user_charity->charity->logo }} " alt="Charity Logo" height="40"> </li>
            </ul>
              @endif
            @endif
          ...
          <ul class="nav navbar-nav float-right">
            ...
            <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#"
                ...
                <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600"> {{ auth('admin')->user()->name }} 
                </span><span class="user-status">ADMIN</span></div><span><img class="round"
                src="{{ asset('images/portrait/small/user.jpg') }}" alt="avatar" height="40"
                    width="40" /></span>
              </a>
              <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="user"><i
                    class="feather icon-user"></i> Account Settings </a><a class="dropdown-item" href="app-email"><i
            ...
            <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#"
                ...
                src="/storage/avatars/{{ auth()->user()->avatar }} " alt="avatar" height="40"
                    width="40" /></span>
              </a>
              <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="/bruger"><i
                    class="feather icon-user"></i> Account Settings </a><a class="dropdown-item" href="app-email"><i
                    class="feather icon-mail"></i> My
                  Inbox</a><a class="dropdown-item" href="app-todo"><i class="feather icon-check-square"></i> Task</a><a
                  class="dropdown-item" href="app-chat"><i class="feather icon-message-square"></i> Chats</a>
