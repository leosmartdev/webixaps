        ...
        <div class="card">
            ...
            <div class="row top-wrapper">
                <div class="col-md-2 campaign-image-wrapper">
                    <img class="job-img" src="https://ai.webixaps.com/storage/campaign_logo/{{  $campaign->campaign_logo }}" alt="{{  $campaign->campaign_name}}"  title="{{  $campaign->campaign_name}}" width="130" height="80">
                </div>
                <div class="col-md-8">
                    <div class="row">
                        <div class="col-md-4  job-range-wrapper text-center">
                            <p class="strong"> {{  $cefv['insurance_subscription'] }} {{ $localize['currency'] }} </p>
                            <small> {{ $localize['insurrance_subscription'] }} </small>
                        </div>
                        <div class="col-md-3 duration-wrapper text-center">
                            <p class="strong"> {{  $cefv['members'] }}  </p>
                            <small> {{ $localize['open_for'] }} </small>
                        </div>
                        <div class="col-md-3 min-age-wrapper text-center">
                            <p class="strong"> {{  $cefv['union_subscription'] }} {{ $localize['currency'] }}  </p>
                            <small> {{ $localize['trade_union'] }} </small>
                        </div>
            ...
            <div class="row middle-wrapper ">
                ...
                @php
                    if ($cefv['job_text_1'] != ""){
                        echo '<span class="text-wrapper">'.$cefv['job_text_1']. '</span>';
                    }
                    if ($cefv['job_text_2'] != ""){
                        echo '<span class="text-wrapper">'.$cefv['job_text_2']. '</span>';
                    }
                    if ($cefv['job_text_3'] != ""){
                        echo '<span class="text-wrapper">'.$cefv['job_text_3']. '</span>';
                    }
                    if ($cefv['job_text_4'] != ""){
                        echo '<span class="text-wrapper">'.$cefv['job_text_4']. '</span>';
                    }
                @endphp
                </div>
