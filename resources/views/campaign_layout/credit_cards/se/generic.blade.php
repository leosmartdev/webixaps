                            ...
                            <div class="d-md-flex col-lg-6 left-section">
                                <div class="col-12 col-md-6">
                                    <div class="col-12 text-center mb-2 p-0">
                                        <img src="https://ai.webixaps.com/storage/campaign_logo/{{  $campaign->campaign_logo }}"
                                             alt="{{  $campaign->campaign_name}}" title="{{  $campaign->campaign_name}}" class="credit-card-img">
                                    </div>
                                ...
                                <div class="col-12 col-md-6">
                                    <table class="table">
                                        <tbody>
                                        <tr>
                                            <td>{{ $localize['maximum_credit_amount'] }}</td>
                                            <th class="text-right">{{  $cefv['maximum_credit_amount'] }} {{ $localize['currency'] }}</th>
                                        </tr>
                                        <tr>
                                            <td>{{ $localize['yearly_fee'] }}</td>
                                            <th class="text-right">{{  $cefv['yearly_fee'] }} {{ $localize['currency'] }}</th>
                                        </tr>
                                        <tr>
                                            <td>{{ $localize['credit_period'] }}</td>
                                            <th class="text-right">{{  $cefv['credit_period'] }} {{ (isset($cefv['duration_type']) && $cefv['duration_type'] =='Months')?$localize['monthes']:$localize['days'] }}</th>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
                                    ...
                                    <ul class="list-group list-group-flush m-0">
                                        @php
                                            if ($cefv['credit_text_1'] != ""){
                                                echo '<li class="list-group-item pl-0 pr-0 pb-2"><p class="text-wrapper">'.$cefv['credit_text_1']. '</p></li>';
                                            }
                                            if ($cefv['credit_text_2'] != ""){
                                                echo '<li class="list-group-item pl-0 pr-0 pb-2"><p class="text-wrapper">'.$cefv['credit_text_2']. '</p></li>';
                                            }
                                            if ($cefv['credit_text_3'] != ""){
                                                echo '<li class="list-group-item pl-0 pr-0 pb-2"><p class="text-wrapper">'.$cefv['credit_text_3']. '</p></li>';
                                            }
                                            if ($cefv['credit_text_4'] != ""){
                                                echo '<li class="list-group-item pl-0 pr-0 pb-2"><p class="text-wrapper">'.$cefv['credit_text_4']. '</p></li>';
                                            }
                                        @endphp
                                    </ul>
                                </div>
