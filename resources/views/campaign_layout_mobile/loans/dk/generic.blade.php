                            ...
                            <div class="d-md-flex col-lg-6 right-section">
                                ...
                                <div class="col-12 col-md-6 align-self-center mb-2 mt-2 mt-lg-0 mb-lg-0 text-center">
                                    <a href="/comparison/go/feed/{{ $campaign->clean_url }}" target="_blank"
                                       class="btn custom-btn-success btn-block mb-2" rel="sponsored"> {{ $localize['button1'] }} </a>
                                    <p class="custom-forry-text">{{ $localize['14_days_forry'] }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
