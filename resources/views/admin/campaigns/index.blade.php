      ...
      <div class="card-content">
        <div class="card-header">
          <div class="float-right">
            <a href="{{ route('admin.campaigns.create')}}" class="btn btn-relief-info mr-1 mb-1 text-white">Add Campaign</a>
          </div>
...
@section('page-script')
  {{-- Page js files --}}
  <script src="{{ asset(mix('js/scripts/webix-list/campaigns.js')) }}"></script>
@endsection
