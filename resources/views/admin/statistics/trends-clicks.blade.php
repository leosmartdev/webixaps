                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-header">
                            <h1 class="text-bold-600"> Top 50 Campaign Long Performance by Clicks </h1>
                        ...
                        <div class="card-body card-dashboard">
                            <ul class="nav nav-pills">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link  active" id="table-tab" href="/admin/statistics/trends/clicks" aria-expanded="true">Clicks</a>
                                </li>
                                <li class="nav-item">
