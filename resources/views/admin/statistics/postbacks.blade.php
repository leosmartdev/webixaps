      ...
      <div class="row">
              ...
              <div class="card-content collapse show">
                <div class="card-body">
                  <div class="users-list-filter">
                    <form action="/admin/statistics/postbacks">
          ...
          <div class="card">
            <div class="card-content">
                  <div class="card-header">
                      <h1 class="text-bold-600">Postbacks: {{($filter->has('campaign_id') && $filter->get('campaign_id') != "All")?$selcampaign->campaign_name:"All" }} - {{ ($filter->has('period_from') && $filter->has('period_to'))?$filter->get('period_from') . " - " .$filter->get('period_to'). " Statistics Per Postback":"Today's Statistics Per Postback" }}</h1>
                              ...
                              <table id="click-events" class="table table-striped table-bordered">
                                  ...
                                  <tbody>
                                    @foreach($statistics as $statistic)
                                        <tr style="cursor:pointer" href="{{ url('admin/statistics/postbacks/'.$statistic->campaign_id) }}">
                                            <td> {{ $statistic->campaign_name }} </td>
                                            <td> {{ $statistic->feed_category_name }} </td>
