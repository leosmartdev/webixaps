                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-header">
                            <h1 class="text-bold-600"> Top 50 Campaign Long Performance by EPC </h1>
                        ...
                        <div class="card-body card-dashboard">
                            <ul class="nav nav-pills">
                                ...
                                <li class="nav-item">
                                  <a class="nav-link active" id="table-tab" href="/admin/statistics/trends/epc" aria-expanded="true">Earnings Per Click</a>
                                </li>
                                <li class="nav-item">
