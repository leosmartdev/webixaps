                    ...
                    <div class="card-body">
                        <div class="row match-height">
                            <div class="col-12 col-sm-6 col-lg-3">
                              <h4 class="text-bold-600"> {{ $filter->get('name') }} </h4>
                              <h6 class="pt-1"> Site Domain </h6>
                            </div>
                            <div class="col-12 col-sm-6 col-lg-3">
                                <h4 class="text-bold-600"> {{ $site_top['total_unique_clicks'] }} </h4>
                                <h6 class="pt-1"> Unique Clicks </h6>
                            </div>
                            <div class="col-12 col-sm-6 col-lg-3">
                                <h4 class="text-bold-600"> {{ $site_top['total_non_unique_clicks'] }} </h4>
                                <h6 class="pt-1"> Non-Unique Clicks </h6>
                            </div>
                            <div class="col-12 col-sm-6 col-lg-3">
                                <h4 class="text-bold-600"> {{ $site_top['total_postback'] }} </h4>
        ...
        <div class="col-12">
              ...
              <div class="card-content collapse show">
                <div class="card-body">
                  <div class="users-list-filter">
                    <form action="/admin/statistics/domains/site">
                      <input type="hidden" name="filter" value="yes">
                      <input type="hidden" name="name" value="{{ $filter->get('name') }}">
                      <div class="row">
          ...
          <div class="card">
            <div class="card-content">
              <div class="card-header">
                <h1 class="text-bold-600"> {{ ($filter->has('period_from') && $filter->has('period_to'))?$filter->get('period_from') . " - " .$filter->get('period_to'). " Clicks and Postbacks":"Today's Clicks and Postbacks" }}</h1>
